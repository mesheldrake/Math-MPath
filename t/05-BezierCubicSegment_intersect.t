...
my @intersections = $mp_bez_seg->bez_bez_intersect($mp_bez_seg);
...
my @intersection_pair = Math::MPath::BezierCubicSegment::bez_bez_intersect($mp_bez_seg_1,$mp_bez_seg_2);
